...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-aemtv8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-aemtv8.containers.anotherwebservice.com/
...
```
git clone git@github.com:sdwqe34/container-aemtv8.git
cd container-aemtv8
```
...
```
docker attach container-aemtv8
```
